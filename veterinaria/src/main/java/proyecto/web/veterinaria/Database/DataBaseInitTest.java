...
public class DataBaseInitTest implements ApplicationRunner{
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        clienteRepository.save(new Cliente("Laura Rodríguez", "876543210", "laura@correo4.com", "876543210", "Activo"));
        clienteRepository.save(new Cliente("Pedro Martínez", "345678901", "pedro@correo5.com", "345678901", "Activo"));
        clienteRepository.save(new Cliente("Ana Sánchez", "765432109", "ana@correo6.com", "765432109", "Activo"));
        clienteRepository.save(new Cliente("Luis González", "456789012", "luis@correo7.com", "456789012", "Activo"));
        clienteRepository.save(new Cliente("Carmen López", "654321098", "carmen@correo8.com", "654321098", "Activo"));
        clienteRepository.save(new Cliente("Sofía Pérez", "567890123", "sofia@correo9.com", "567890123", "Activo"));
        clienteRepository.save(new Cliente("Andrés Rodríguez", "543210987", "andres@correo10.com", "543210987", "Activo"));
        clienteRepository.save(new Cliente("Elena Martínez", "432109876", "elena@correo11.com", "432109876", "Activo"));
        clienteRepository.save(new Cliente("Javier Sánchez", "321098765", "javier@correo12.com", "321098765", "Activo"));
        clienteRepository.save(new Cliente("Isabel García", "210987654", "isabel@correo13.com", "210987654", "Activo"));
        clienteRepository.save(new Cliente("Raul López", "109876543", "raul@correo14.com", "109876543", "Activo"));
        clienteRepository.save(new Cliente("Silvia Pérez", "987654322", "silvia@correo15.com", "987654322", "Activo"));
        clienteRepository.save(new Cliente("Diego Rodríguez", "234567891", "diego@correo16.com", "234567891", "Activo"));
        clienteRepository.save(new Cliente("Eva Martínez", "876543211", "eva@correo17.com", "876543211", "Activo"));
        clienteRepository.save(new Cliente("Pablo Sánchez", "345678902", "pablo@correo18.com", "345678902", "Activo"));
        clienteRepository.save(new Cliente("Marta López", "765432110", "marta@correo19.com", "765432110", "Activo"));
        clienteRepository.save(new Cliente("Raúl González", "456789013", "raul@correo20.com", "456789013", "Activo"));
        clienteRepository.save(new Cliente("Ana María Pérez", "654321099", "anamaria@correo21.com", "654321099", "Activo"));
        clienteRepository.save(new Cliente("Carlos Fernández", "567890124", "carlos@correo22.com", "567890124", "Activo"));
        clienteRepository.save(new Cliente("Luisa Rodríguez", "543210988", "luisa@correo23.com", "543210988", "Activo"));
        clienteRepository.save(new Cliente("José López", "432109877", "jose@correo24.com", "432109877", "Activo"));
        clienteRepository.save(new Cliente("Rosa García", "321098766", "rosa@correo25.com", "321098766", "Activo"));
        clienteRepository.save(new Cliente("Jorge Martínez", "210987655", "jorge@correo26.com", "210987655", "Activo"));
        clienteRepository.save(new Cliente("María José Sánchez", "109876544", "mariajose@correo27.com", "109876544", "Activo"));
        clienteRepository.save(new Cliente("Manuel Pérez", "987654323", "manuel@correo28.com", "987654323", "Activo"));
        clienteRepository.save(new Cliente("Cristina Rodríguez", "234567892", "cristina@correo29.com", "234567892", "Activo"));
        clienteRepository.save(new Cliente("Sergio López", "876543213", "sergio@correo30.com", "876543213", "Activo"));
        clienteRepository.save(new Cliente("Beatriz Martínez", "345678903", "beatriz@correo31.com", "345678903", "Activo"));
        clienteRepository.save(new Cliente("Antonio Sánchez", "765432111", "antonio@correo32.com", "765432111", "Activo"));
        clienteRepository.save(new Cliente("Natalia Pérez", "456789014", "natalia@correo33.com", "456789014", "Activo"));
        clienteRepository.save(new Cliente("Daniel García", "654321100", "daniel@correo34.com", "654321100", "Activo"));
        clienteRepository.save(new Cliente("Lucía López", "567890125", "lucia@correo35.com", "567890125", "Activo"));
        clienteRepository.save(new Cliente("Juan José Rodríguez", "543210990", "juanjose@correo36.com", "543210990", "Activo"));
        clienteRepository.save(new Cliente("Mónica Martínez", "432109879", "monica@correo37.com", "432109879", "Activo"));
        clienteRepository.save(new Cliente("Paco Sánchez", "321098768", "paco@correo38.com", "321098768", "Activo"));
        clienteRepository.save(new Cliente("Teresa Pérez", "210987657", "teresa@correo39.com", "210987657", "Activo"));
        clienteRepository.save(new Cliente("Roberto García", "109876546", "roberto@correo40.com", "109876546", "Activo"));
        clienteRepository.save(new Cliente("Isabella López", "987654324", "isabella@correo41.com", "987654324", "Activo"));
        clienteRepository.save(new Cliente("Manuela Rodríguez", "234567893", "manuela@correo42.com", "234567893", "Activo"));
        clienteRepository.save(new Cliente("Alejandro Martínez", "876543214", "alejandro@correo43.com", "876543214", "Activo"));
        clienteRepository.save(new Cliente("Patricia Sánchez", "345678905", "patricia@correo44.com", "345678905", "Activo"));
        clienteRepository.save(new Cliente("Gabriel Pérez", "765432112", "gabriel@correo45.com", "765432112", "Activo"));
        clienteRepository.save(new Cliente("Lucas García", "456789015", "lucas@correo46.com", "456789015", "Activo"));
        clienteRepository.save(new Cliente("Elena López", "654321101", "elena@correo47.com", "654321101", "Activo"));
        clienteRepository.save(new Cliente("Olivia Martínez", "567890126", "olivia@correo48.com", "567890126", "Activo"));
        clienteRepository.save(new Cliente("Juan Carlos Rodríguez", "543210989", "juancarlos@correo49.com", "543210989", "Activo"));
        clienteRepository.save(new Cliente("Sara Sánchez", "432109878", "sara@correo50.com", "432109878", "Activo"));
        clienteRepository.save(new Cliente("Miguel Pérez", "321098767", "miguel@correo51.com", "321098767", "Activo"));
        clienteRepository.save(new Cliente("Cecilia García", "210987656", "cecilia@correo52.com", "210987656", "Activo"));
        clienteRepository.save(new Cliente("Pablo López", "109876545", "pablo@correo53.com", "109876545", "Activo"));
        clienteRepository.save(new Cliente("Ximena Martínez", "987654325", "ximena@correo54.com", "987654325", "Activo"));
        clienteRepository.save(new Cliente("Andrea Rodríguez", "234567894", "andrea@correo55.com", "234567894", "Activo"));
        clienteRepository.save(new Cliente("Adrián Sánchez", "876543215", "adrian@correo56.com", "876543215", "Activo"));
        clienteRepository.save(new Cliente("Valentina Pérez", "345678906", "valentina@correo57.com", "345678906", "Activo"));
        clienteRepository.save(new Cliente("Hugo García", "765432113", "hugo@correo58.com", "765432113", "Activo"));
        clienteRepository.save(new Cliente("Marina López", "456789016", "marina@correo59.com", "456789016", "Activo"));
        clienteRepository.save(new Cliente("Gustavo Martínez", "654321102", "gustavo@correo60.com", "654321102", "Activo"));
        clienteRepository.save(new Cliente("Rocío Rodríguez", "567890127", "rocio@correo61.com", "567890127", "Activo"));
        clienteRepository.save(new Cliente("Francisco Sánchez", "543210991", "francisco@correo62.com", "543210991", "Activo"));
        clienteRepository.save(new Cliente("Camila Pérez", "432109880", "camila@correo63.com", "432109880", "Activo"));
        clienteRepository.save(new Cliente("Iván García", "321098769", "ivan@correo64.com", "321098769", "Activo"));
        clienteRepository.save(new Cliente("Valeria López", "210987658", "valeria@correo65.com", "210987658", "Activo"));
        clienteRepository.save(new Cliente("Eduardo Martínez", "109876547", "eduardo@correo66.com", "109876547", "Activo"));
        clienteRepository.save(new Cliente("Natalie Rodríguez", "987654326", "natalie@correo67.com", "987654326", "Activo"));
        clienteRepository.save(new Cliente("Arturo Sánchez", "234567895", "arturo@correo68.com", "234567895", "Activo"));
        clienteRepository.save(new Cliente("Carolina Pérez", "876543216", "carolina@correo69.com", "876543216", "Activo"));
        clienteRepository.save(new Cliente("Roberto López", "345678907", "roberto@correo70.com", "345678907", "Activo"));
        clienteRepository.save(new Cliente("Sandra Martínez", "765432114", "sandra@correo71.com", "765432114", "Activo"));
        clienteRepository.save(new Cliente("Martín García", "456789017", "martin@correo72.com", "456789017", "Activo"));
        clienteRepository.save(new Cliente("Alicia Rodríguez", "654321103", "alicia@correo73.com", "654321103", "Activo"));
        clienteRepository.save(new Cliente("Diego Sánchez", "567890128", "diego@correo74.com", "567890128", "Activo"));
        clienteRepository.save(new Cliente("Lorena Pérez", "543210992", "lorena@correo75.com", "543210992", "Activo"));
        clienteRepository.save(new Cliente("Fernando López", "432109881", "fernando@correo76.com", "432109881", "Activo"));
        clienteRepository.save(new Cliente("Gabriela Martínez", "321098770", "gabriela@correo77.com", "321098770", "Activo"));
        clienteRepository.save(new Cliente("Eduardo Rodríguez", "210987659", "eduardo@correo78.com", "210987659", "Activo"));
        clienteRepository.save(new Cliente("Isidro Sánchez", "109876548", "isidro@correo79.com", "109876548", "Activo"));
        clienteRepository.save(new Cliente("Paola Pérez", "987654327", "paola@correo80.com", "987654327", "Activo"));
        clienteRepository.save(new Cliente("Luciano García", "234567896", "luciano@correo81.com", "234567896", "Activo"));
        clienteRepository.save(new Cliente("Luz López", "876543217", "luz@correo82.com", "876543217", "Activo"));
        clienteRepository.save(new Cliente("Antonia Martínez", "345678908", "antonia@correo83.com", "345678908", "Activo"));
        clienteRepository.save(new Cliente("Ricardo Rodríguez", "765432115", "ricardo@correo84.com", "765432115", "Activo"));
        clienteRepository.save(new Cliente("Mariana Sánchez", "456789018", "mariana@correo85.com", "456789018", "Activo"));
        clienteRepository.save(new Cliente("Joaquín Pérez", "654321104", "joaquin@correo86.com", "654321104", "Activo"));
        clienteRepository.save(new Cliente("Laura García", "567890129", "laura@correo87.com", "567890129", "Activo"));
        clienteRepository.save(new Cliente("Fernanda López", "543210993", "fernanda@correo88.com", "543210993", "Activo"));
        clienteRepository.save(new Cliente("Héctor Martínez", "432109882", "hector@correo89.com", "432109882", "Activo"));
        clienteRepository.save(new Cliente("Valentín Sánchez", "321098771", "valentin@correo90.com", "321098771","Activo"));
        clienteRepository.save(new Cliente("Rosa Rodríguez", "210987660", "rosa@correo91.com", "210987660","Activo"));
        clienteRepository.save(new Cliente("Julián Pérez", "109876549", "julian@correo92.com", "109876549","Activo"));
        clienteRepository.save(new Cliente("Aurora García", "987654328", "aurora@correo93.com", "987654328","Activo"));
        clienteRepository.save(new Cliente("Germán López", "234567897", "german@correo94.com", "234567897","Activo"));
        clienteRepository.save(new Cliente("Carla Martínez", "876543218", "carla@correo95.com", "876543218","Activo"));
        clienteRepository.save(new Cliente("Raul Sánchez", "345678909", "raul@correo96.com", "345678909","Activo"));
        clienteRepository.save(new Cliente("Victoria Pérez", "765432116", "victoria@correo97.com", "765432116","Activo"));
        clienteRepository.save(new Cliente("Renato Rodríguez", "456789019", "renato@correo98.com", "456789019","Activo"));
        clienteRepository.save(new Cliente("Claudia López", "654321105", "claudia@correo99.com", "654321105","Activo"));
        clienteRepository.save(new Cliente("Gonzalo Martínez", "567890130", "gonzalo@correo100.com", "567890130","Activo"));
