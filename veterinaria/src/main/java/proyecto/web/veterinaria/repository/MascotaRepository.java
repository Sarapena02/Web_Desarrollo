...
public class MascotaRepository {
    ...
    public MascotaRepository(){
        ...
        mascotas.put(2, new Mascota("Sasha", "Siames", 3, "Hipotrofia", "Activo","",2));
        mascotas.put(3, new Mascota("Jack", "Siames", 2, "Hipotrofia", "Activo","",3));
        mascotas.put(4, new Mascota("Jack", "Siames", 2, "Hipotrofia", "Activo","",4));
        mascotas.put(5, new Mascota("Jack", "Siames", 2, "Hipotrofia", "Activo","",5));
    }
